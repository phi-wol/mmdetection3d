...
class_names = ["chair", "book"] # TODO: single class?
img_norm_cfg = dict(
...
test_inference_book=dict(
        type=dataset_type,
        data_root=data_root_book,
        ann_file= data_root_book + '/annotations/objectron_test.json',# ann_file_test,
        img_prefix=data_root_book,
        classes=class_names,
        pipeline=test_pipeline, # TODO: Change?
        modality=input_modality,
...
model = dict(
    ...
    bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            base_dims=  (
                (0.5740664085137888, 0.8434027515832329, 0.6051523831888338),
                (0.225618019, 0.03949624326, 0.1625821624)
