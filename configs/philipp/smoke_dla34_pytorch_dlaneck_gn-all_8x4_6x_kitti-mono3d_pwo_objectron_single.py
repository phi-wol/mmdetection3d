...
lr_config = dict(policy='step', warmup=None, step=[]) # 50, 100, 150
...
dataset_type = 'KittiMonoDataset' # TODO: new dataset? change loading and evaluation procedure # 'KittiMonoDatasetObjectron'
...
data = dict(
    ...
    train=dict(
        ...
        info_file= data_root + '/annotations/objectron_train_single.json',
