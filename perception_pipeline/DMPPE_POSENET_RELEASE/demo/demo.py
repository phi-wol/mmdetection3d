...
def inference_pose_net_single_frame(input_image, bbox_list, root_depth_list):
    ...
    # snapshot load
    # model_path = './posenet_%d.pth.tar' % int(args.test_epoch)
    model_path = './posenet_24.pth.tar'
