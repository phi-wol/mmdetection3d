...
def inference_root_net_single_frame(input_image, bbox_list, model, focal=None, princpt=None):
    ...
    # TODO: set variable w.r.t to used camera
    ...
    for n in range(person_num):
        ...
        # visual debug of root prediction
        ...
        if visual_debug: 
            ...
            cv2.imwrite('output/output_root_2d_' + str(n) + '.jpg', vis_img)
